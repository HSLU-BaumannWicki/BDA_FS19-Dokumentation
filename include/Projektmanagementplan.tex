...
Weiter konnte im verlauf des Sprints noch ein konstruktives Feedback von Herr Jud, bezüglich dem Inhaltlichen Aufbau der Dokumentation, abgeholt werden. Dieses Feedback führte zu einem Replanning, bei welchem neue Arbeitspakete erstellt wurden, welche die von Herr Jud kritisierten Punkte verbesserten. Gegen Ende des Sprints konnte die die Dokumentation in eine Finalisierten zustand gebracht werden, in welcher die Dokumentation schliesslich abgegeben wurde.

Während dem Sprint traten keine gravierende Probleme auf.
