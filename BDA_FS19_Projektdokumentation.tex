...
\begin{itemize}
	\item Die Machbarkeitsstudie muss mindestens 2 Unterschiedliche Lösungsansätze beinhalten.
...
\begin{itemize}
	\item Die Lösungsansätze müssen mit dem Lagersystem kommunizieren können
	\item Die Lösungsansätze müssen die RFID tags in weniger als 1s identifizieren können.
	\item Die Lösungsansätze müssen für das bestehende Hochregallager der Speicherbibliothek verwendbar sein.
